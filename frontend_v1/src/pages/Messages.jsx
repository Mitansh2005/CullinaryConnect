      ...
      <div>
        <div className="w-full bg-white h-96">
          ...
          <div className="pt-6 pl-7">
            <div className="w-72 bg-gray-300 rounded-xl p-2" >
              <div><p className="text-sm font-bold mb-2">Sender Name</p></div>
              <div><p className="text-sm">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Vero exercitationem dolor voluptatibus earum aperiam, nobis mollitia adipisci sit nostrum error cumque vel reiciendis nam illo, labore architecto, fugit autem ut?</p></div>
            </div>
        ...
        <div className="mt-6 flex flex-col mb-6 bg-white" >
          <input type="text" placeholder="Enter message here" name="message-text" className="h-20 w-full p-4 focus:outline-none focus:border-b-4 focus:border-blue-400 ease-linear duration-150"></input>
