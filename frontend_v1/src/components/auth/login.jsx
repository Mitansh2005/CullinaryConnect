...
function LoginTemplate() {
	//This is used to redirect the user if he is already logged in
	// const {...userLoggedIn}=useAuth() //There is a error as destructing of the userLoggedIn is not working
